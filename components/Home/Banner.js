        ...
        <div className="container-fluid mx-auto px-5">
          <div className="banner_content_wrapper flex items-center slider_screen">
            <div className="banner_content_left md:w-8/12 lg:w-6/12 ">
              <h1 className="title text-3xl sx:text-4xl xl:text-6xl font-bold text-white">
                Welcome to Client handle{" "}
                <span className="">freelance market</span>
              </h1>
              <p className="description text-md sx:text-lg font-medium text-white mt-2">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Error
                molestiae explicabo fugit debitis libero quae iste odit autem
                repellendus. Quis corrupti possimus error aliquid, atque debitis
                numquam delectus tempore perferendis!
              </p>
              <button className="button mt-3 text-lg py-2 px-8 border-2 text-gray-50 hover:bg-transparent bg-gray-900 rounded-full transition-all duration-300 ease-in-out">
                Go Now
              </button>
            </div>
