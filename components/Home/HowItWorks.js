...
const HowItWorks = () => {
  ...
  <div className='grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1  gap-12 '>
        ...
        <div className='mt-10'>
          ...
          <iframe className={`${styles.how_it_work_img} w-full`} height="380" src="https://www.youtube.com/embed/77g4KA9WQL4" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" ></iframe>
        </div>
      </div>
  </div>
    </section>
