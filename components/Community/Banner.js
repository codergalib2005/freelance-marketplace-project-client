...
const Banner = () => {
    return (
        ...
        <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 items-center">
          <div >
            <div >
              <h4 className="text-4xl md:text-4xl lg:text-6xl  		">
              ...
              <button className="bg-green-500 border-2 hover:bg-orange-200 border-green-500 px-6 py-2 text-lg font-medium  transition-all duration-500 hover:text-green-500 text-white rounded-md ">
                Sign up now
              </button>
            </div>
         ...
         <div className=" flex justify-center items-center ">
            ...
            <img className="lg:w-[28rem]" src="/community/connection-people.png" alt="" />
            ...
            <div className="hidden lg:block " >
              ...
              <h4 className="text-3xl font-semibold">$12</h4>
               ...
               <h4 className="text-base px-10  pt-4  text-white">For Team Subscription </h4>
