      ...
      <div className={styles.header_section}>
        <div className="container m-auto flex justify-between items-center text-gray-700">
          ...
          <ul className="hidden md:flex items-center  text-base font-semibold text-white cursor-pointer">
            ...
            <Link href="/">
              <a className="hover:text-green-400 text-lg font-bold py-4 px-6">Explore</a>
            </Link>
        ...
        <div className='px-8 py-24'>
          <div>
            <h2 className='sx:text-3xl xl:text-5xl font-bold  text-white'>About Workfleek<br /> Why We Are Best?</h2>
