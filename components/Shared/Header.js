...
const Header = ({ bg }) => {
  ...
  return (
    <div style={{ zIndex: "1000" }} className="fixed top-0 left-0 w-full">
      <nav
        className={`fixed top-0 left-0 w-full shadow transition-all duration-500 ease-linear ${showBg ? "bg-gray-900" : bg}`}
        style={{ zIndex: "289" }}
      >
        <div className="container m-auto flex justify-between items-center text-gray-700">
          ...
          <ul className="hidden md:flex items-center  text-base font-semibold text-white cursor-pointer">
            ...
            <Link href="/become&seller">
              <a className="hover:text-green-400 text-lg py-4 px-6">Become a Seller</a>
            </Link>
            <Link href="/gig_add">
      ...
      group-focus:right-0 group-focus:opacity-100 transition-all duration-300"
            >
              <ul className="flex flex-col items-end w-full text-base cursor-pointer pt-10">
                <li className="bg-green-600 hover:bg-green-800 rounded-sm px-8 py-2 font-bold text-white -mt-6 mr-8 ">Join Freelance</li>

                <Link href="/">
                  <a className="hover:text-green-400 mr-10 text-lg pt-6 pb-2 px-6">Sign in</a>
                </Link>
                <Link href="/">
                  <a className="hover:text-green-400 mr-10 text-lg  px-6">Freelance Business</a>
                </Link>
                <Link href="/">
                  <a className="hover:text-green-400 mr-10 text-lg py-2 px-6">Explore</a>
                </Link>
                <li className=" pt-2 px-6 font-medium mr-10 text-semibold">General</li>
                <hr className="w-full" />
                <Link href="/">
                  <a className="hover:text-green-400 mr-10 text-lg pt-6 pb-2 px-6">Home</a>
                </Link>
                <Link href="/">
                  <a className="hover:text-green-400 mr-10 text-lg py-2  px-6">Contact</a>
                </Link>
                <Link href="/">
                  <a className="hover:text-green-400 mr-10 text-lg py-2  px-6">Services</a>
                </Link>
                <Link href="/">
                  <a className="hover:text-green-400 mr-10 text-lg py-2  px-6">About</a>
                </Link>
              </ul>
            </div>
          </button>
