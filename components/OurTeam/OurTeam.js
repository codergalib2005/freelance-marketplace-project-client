      ...
      <div className="container mx-auto px-10 lg:px-0 my-10">
        <div className="  grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-8">
          {team.map((member) => (
            <div
              key={member.id}
              className="border-0 border-gray-500 h-[27rem] translate transition-all duration-300 hover:bg-teal-200  bg-white relative "
            >
              ...
              <div className="mx-4">
                <button className="text-base font-bold px-6 w-full py-2 text-white bg-indigo-500 border-0 rounded-md active:bg-indigo-700 my-6">
                  About Me
                </button>
              </div>
            </div>
