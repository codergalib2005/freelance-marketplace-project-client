      ...
      <nav >
        <ul className="grid grid-rows-4">
          <li className="flex items-center mx-8 space-x-2">
              ...
              <img className="w-6 profile"  src="/menu/manage-profile.svg" alt=""  />
              </div>
          ...
          <div>
                {/* eslint-disable-next-line @next/next/no-img-element */}
              <img className="w-6 profile"  src="/menu/security-setting.svg" alt=""   />
              </div>
          ...
          <div>
                {/* eslint-disable-next-line @next/next/no-img-element */}
              <img className="w-6 profile"  src="/menu/notifications-active.svg" alt=""   />
              </div>
            <Link href="/setting/notification">
              <a className="hover:text-blue-600 text-lg  ">
                Notification
              </a>
            </Link>
          </li>
          ...
          <div>
                {/* eslint-disable-next-line @next/next/no-img-element */}
              <img className="w-6 profile"  src="/menu/payment-card.svg" alt=""   />
              </div>
            <Link href="/">
