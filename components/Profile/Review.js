        ...
        <div className="p-4 border border-gray-400 mt-5 rounded-md">
          ...
          <div>
            <p className="text-gray-400 text-md pb-3">
              Hi I am shahnaz Ahmad and I am here to give you the services of
              both iOS and Android app development. I have 8+ years of
              experience in mobile app development. I can develop any app based
              on client requirements as I have worked from basics to advanced
              concepts of app development. I am here to take your ideas and make
              them a reality. I will also help you to make these realities even
              better. I work with full dedication and treat my s work as my own.
              Contact me without hesitation with your requirements.
            </p>
            <p className="text-gray-400 text-md pt-3 border-t border-gray-500">
              Hi I am shahnaz Ahmad and I am here to give you the services of
              both iOS and Android app development. I have 8+ years of
              experience in mobile app development. I can develop any app based
              on client requirements as I have worked from basics to advanced
