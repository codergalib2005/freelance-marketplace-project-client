...
//       return;
//     }
//     registerUser(loginData.email, loginData.password, loginData.name, loginData.password2);
//     e.preventDefault();
//   }
...
const register = () => {
  ...
  const { user, registerUser, signInWithGoogle, loading, error, userStatus } = useAuth();
  // eslint-disable-next-line react-hooks/rules-of-hooks
