          ...
          <div>
            ...
            <div className="md:flex lg:flex gap-8">
              ...
              <div className="flex gap-7">
                ...
                <a className="">
                  <svg
                    className="inline-block border-[1px] border-indigo-500 svg-hover hover:bg-indigo-500 p-3 hover:fill-white"
                ...
                <a className="">
                  <svg
                    className="inline-block border-[1px] border-blue-400 svg-hover hover:bg-blue-400 p-3 hover:fill-white"
                    xmlns="http://www.w3.org/2000/svg"
                    width="50"
                    height="50"
                    viewBox="0 0 16 16"
