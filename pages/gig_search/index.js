      ...
      <nav className="bg-[#2a3254]">
        <div className="container-fluid mx-auto px-3 py-2">
          <div className="flex items-center justify-between">
            ...
            <div
              className="flex rounded-full pr-5  bg-gray-50 items-center h-14 w-full"
            ...
            >
              ...
              <input
                className="w-full h-10 rounded-full p-2 outline-none"
                type="text"
                placeholder="search"
                onChange={(e) => {
      ...
      <div className="bg-[#2a3254] min-h-screen">
        <div className="flex justify-between gap-4 relative">
          ...
          <div
            ...
            className={`content_scrollbar transition-all duration-300 py-10 ease-linear w-full bg-[#2a3254] h-4 min-h-screen text-white mx-auto px-6 ${
