        ...
        <div className="w-10/12 mx-auto mt-6">
          <form onSubmit={handleSubmit(onSubmit)}>
            <div>
              {/*======Overview======*/}
              {
                state.showPage === "MAIN_PAGE" && (
                  <div className="shadow-lg border-4 p-6 rounded-lg border-green-300">
                    <div>
                      <div className="flex">
                        <span className="w-2/12 text-xl font-bold">Gig Title</span>
                        <div className="w-10/12">
                          <textarea className=" border w-full text-3xl p-2 border-gray-300 rounded-md" {...register("gig_title", { required: true, maxLength: 100 })} />
                          {errors.gig_title && <span className="text-red-700 block">Service title is required max length 100 letter!</span>}
                        </div>
                      </div>
                      <div>
                        <div className="flex py-6">
                          ...
                          <div className="w-8/12">
                            <select className="border border-gray-300 h-12 text-lg w-full rounded-md" {...register("category", { required: true })}>
                              <option value="Digital Marketing">Digital Marketing</option>
                              <option value="Programming and teach">Programming and teach</option>
                        ...
                        <div>
                          <textarea placeholder="Service Description" className="w-full border border-gray-400 p-2 rounded-md" {...register("description", { required: true })} rows="6"></textarea>
                          {errors.description && <span className="text-red-700 block">Service main description is required</span>}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="shadow-lg border-4 p-6 rounded-lg border-green-300">
                    <div className="grid grid-cols-3">
                      <div className="border border-gray-1">
                        <div className="text-2xl py-3 bg-gray-300 pl-3">Basic</div>
                        <div>
                          <textarea rows="4" className="px-2 border-t border-gray-300 w-full" {...register("first_title", { required: true })} placeholder="Service Title"></textarea>
                          {errors.first_title && <span className="text-red-700 block">Service Title is required</span>}
                          <textarea rows="5" className="px-2 border-t border-gray-300 w-full" {...register("first_desc", { required: true })} placeholder="Service description"></textarea>
                          {errors.first_desc && <span className="text-red-700 block">Service description is required</span>}
                          <select className="border border-gray-300 h-12 text-lg w-full rounded-md" {...register("first_day", { required: true })}>
                      ...
                      <div className="border border-gray-1">
                        <div className="text-2xl py-3 bg-gray-300 pl-3">Advance</div>
                        <div>
                          <textarea rows="3" className="px-2 border-t border-gray-300 w-full" {...register("second_title", { required: true })} placeholder="Service Title"></textarea>
                          {errors.second_title && <span className="text-red-700 block">Service Title is required</span>}
                          <textarea rows="5" className="px-2 border-t border-gray-300 w-full" {...register("second_desc", { required: true })} placeholder="Service description"></textarea>
                          {errors.second_desc && <span className="text-red-700 block">Service description is required</span>}
                          <select className="border border-gray-300 h-12 text-lg w-full rounded-md" {...register("second_day", { required: true })}>
                      ...
                      <div className="border border-gray-1">
                        <div className="text-2xl py-3 bg-gray-300 pl-3">Enterprise</div>
                        <div>
                          <textarea rows="5" className="px-2 border-t border-gray-300 w-full" {...register("third_title", { required: true })} placeholder="Service Title"></textarea>
                          {errors.third_title && <span className="text-red-700 block">Service Title is required</span>}
                          <textarea className="px-2 border-t border-gray-300 w-full" {...register("third_desc", { required: true })} placeholder="Service description" rows="4"></textarea>
                          {errors.third_desc && <span className="text-red-700 block">Service description is required</span>}
                          <select className="border border-gray-300 h-12 text-lg w-full rounded-md" {...register("third_day", { required: true })}>
              ...
              {/*======Gallery======*/}
              {
                state.showPage === "GALLERY_PAGE" && (
                  <div style={{ minHeight: '300px' }} className="shadow-lg border-4 p-6 rounded-lg border-green-300">
            ...
            <div>
              {state.showPage === "MAIN_PAGE" && (
                <div className="mt-4">
                  <button onClick={() => dispatch({ type: "PRICING_PAGE" })} className="py-2 px-3 bg-green-900 text-white font-bold text-lg">Next</button>
                </div>
              )
              }
              {state.showPage === "PRICING_PAGE" && (
                <div className="mt-4">
                  <button onClick={() => dispatch({ type: "GALLERY_PAGE" })} className="py-2 px-3 bg-green-900 text-white font-bold text-lg">Next</button>
                  <button onClick={() => dispatch({ type: "MAIN_PAGE" })} className="py-2 px-3 text-green-900 font-bold text-lg">Back</button>
                </div>
              )
              }
              {state.showPage === "GALLERY_PAGE" && (
