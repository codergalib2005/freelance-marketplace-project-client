        ...
        <div className="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-8">
          <form>
            ...
            "
              ...
              <hr className="mt-14" />
              <div>
                <h2 className="text-lg font-bold text-gray-600 mb-2 mt-4">
                  Choose Your Category
                </h2>
                <div className="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1">
                  <div className="text-lg ml-5 ">
                    <select
                      className={`outline-green-400 border border-gray-300 w-full ${styles.request_choose}`}
                    >
                ...
                <div>
                  <h2 className="text-lg font-bold text-gray-600 mb-2 mt-4">
                    Once You Place Your Order Would You Like Your Service
                    Delivered?{" "}
                  </h2>
                </div>
                <div className="mt-5">
              ...
              <div>
                <h2 className="text-lg font-bold text-gray-600 mb-2 mt-4">
                  What your Budget For This Services?{" "}
                </h2>
